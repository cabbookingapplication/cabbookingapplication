...
*/
	...
	public TripBooking(User user, Driver driver, String fromLocation, String toLocation, String fromDateTime,
			String toDateTime, boolean status, float distanceInKm,String cabType, float bill) {
		super();
		this.user = user;
		this.driver = driver;
		this.fromLocation = fromLocation;
